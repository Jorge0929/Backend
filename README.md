...
Crear un archivo `.env` en la raíz del proyecto backend con las siguientes variables. **No subas este archivo a Git.**

```env
PORT=4000
MONGODB_URI=tu_string_de_conexion_a_mongodb_aqui
JWT_SECRET=tu_secreto_jwt_largo_y_aleatorio_aqui